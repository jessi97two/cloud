...
{
	$sql = "INSERT INTO `mpm`.`users` (`username`, `password`, `surname`, `name`, `email`)";
...
{
	$sql = "INSERT INTO `mpm`.`files` (`user_id`, `folder_id`, `name`, `tag`, `commentaire`, `version`, `date)";
...
{
	$sql = "INSERT INTO `mpm`.`folders`(`user_id`, `name`, `date`)";
